...
import vespaGTS_125_superSport from './Vespa/GTS/Vespa_GTS_125_SuperSport_Euro_5.json'; // <-- A tua SuperSport preservada!
...
export const MOTORCYCLE_REGISTRY: Record<string, Motorcycle> = {
  ...
  'vespa-gts-125-supersport-euro-5': vespaGTS_125_superSport as unknown as Motorcycle, // <-- A tua SuperSport registada!
...
export const getMotorcycleBySlug = (slug: string): Motorcycle | undefined => {
  return MOTORCYCLE_REGISTRY[slug.toLowerCase()]; // Notei que os teus colegas melhoraram esta função, mantive a melhoria deles!
};