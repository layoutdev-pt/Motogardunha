        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center animate-in zoom-in-95 duration-300">
            ...
            <p className="text-zinc-600 mb-6">
              Obrigado pela sua reserva. Entraremos em contacto consigo brevemente para agendar o levantamento na nossa loja.
            </p>
            <button
              onClick={onSuccess}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  id="notes"
                  {...register("notes")}
                  placeholder="Tamanho, cor, ou outros pedidos especiais"
                  rows={2}
